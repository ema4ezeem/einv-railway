...
# Railway provides Redis URL in the REDISHOST, REDISPORT, and REDISPASSWORD format
...
try:
    ...
    # Fallback to simple memory storage if Redis connection fails
    redis_client = None
    redis_url = "memory://"
...
limiter = Limiter(
    ...
    storage_options={"connection_pool": redis_client.connection_pool if redis_client else None},
    default_limits=["2000 per day", "500 per hour"]
)

# Railway uses relative paths in deployment
